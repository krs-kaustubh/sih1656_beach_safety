// File: lib/models/conditions.dart
// Description: Data models and enums representing environmental conditions (wave height, wind speed, UV index, tides, water temperature, water quality).
...
class Conditions {
  ...
  // Air temperature kept distinct from water temperature.
  final double? airTempCelsius;

  // Free-form water quality string on the backend today (e.g. Excellent / Moderate / Poor).
  final String? waterQuality;

  // The service's own UV category wording when provided.
  ...
  // Tolerant parser ignoring unknown fields and turning missing fields into null.
